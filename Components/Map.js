...
import {addRoute, getInformation, UpdatedRoutes} from "./API/RouteAPI";
...
const Map = () => {
    ...
    return (
        <>
            ...
            <HelpDialog routeDisplay={routeFocused} routeInformation={routeInformationJSON} setRouteDisplay={setRouteFocused}/>
        </>
    )
}
...
const HelpDialog = ({routeDisplay, routeInformation,...props}) => {
    return (
        ...
        <View style={{
            ...
            {routeDisplay ? <HelpDialogContent routeInformation={routeInformation} {...props}/> : <Text style={{fontSize: 16, color: '#FDAF01'}}>Tap a route for more information</Text>}
        </View>
        </>
    )
}
    ...
    return (
        <View style={{flexDirection: 'column', width: "100%", height: '100%'}}>
            <View style={{flex: 0.25, flexDirection: 'row', alignItems: 'center'}}>
                <Image style={{height: 60, width: 60, borderRadius: 30, flex: 0.2}} source={{uri: routeInformation.Photo}}/>
                <Text style={{left: '20%', fontSize: 22, textDecorationLine: "underline", flex: 0.7, color: 'white'}}>{routeInformation.Name}</Text>
            ...
            <View style={{flex: 0.25, flexDirection: 'row', padding: 0}}>
                <CustomButton color={'transparent'} text={"View Profile"}
                              buttonStyle={{borderWidth: 1, borderColor: 'white', height: '100%', margin: 0, marginRight: 5}}
                />
                <CustomButton color={'#FDAF01'} text={"Message"} buttonStyle={{height: '100%', margin: 0, marginLeft: 5}}/>
            </View>
        </View>
    )
}
